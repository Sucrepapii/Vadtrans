...
export const tripAPI = {
  ...
  toggleAvailability: (id, data) => api.patch(`/trips/${id}/availability`, data),
};
...
export const adminAPI = {
  ...
  promptDocs: () => api.post("/admin/companies/prompt-docs"),
...
export const privateRideAPI = {
  ...
  negotiateBid: (bidId, amount) => api.post(`/private-rides/bids/${bidId}/negotiate`, { amount }),
  notInterestedBid: (bidId) => api.post(`/private-rides/bids/${bidId}/not-interested`),
  driverAcceptBid: (bidId) => api.post(`/private-rides/bids/${bidId}/driver-accept`),
