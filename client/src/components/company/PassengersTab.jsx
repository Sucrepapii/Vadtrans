...
const PassengersTab = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case "confirmed":
        return (
          <span className="flex items-center gap-1 text-sm text-green-700 bg-green-100 px-2 py-1 rounded-full w-fit">
            <FaCheckCircle className="text-xs" /> Confirmed
          </span>
        );
      case "cancelled":
        return (
          <span className="flex items-center gap-1 text-sm text-red-700 bg-red-100 px-2 py-1 rounded-full w-fit">
            <FaTimesCircle className="text-xs" /> Cancelled
          </span>
        );
      default:
        return (
          <span className="flex items-center gap-1 text-sm text-blue-700 bg-blue-100 px-2 py-1 rounded-full w-fit">
            {status}
          </span>
        );
    }
