...
const TicketsManagement = () => {
  ...
  const locationOptions = useMemo(() => {
    if (formData.transportType.includes("international")) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              <option value="bus-international">Bus - International</option>
              <option value="car-domestic">Car - Domestic</option>
              <option value="car-international">Car - International</option>
            </select>
          </div>
          ...
          <div>
            ...
            <select
              ...
              <option value="">
                Select departure{" "}
                {formData.transportType.includes("international")
                  ? "country"
                  : "state"}
              </option>
