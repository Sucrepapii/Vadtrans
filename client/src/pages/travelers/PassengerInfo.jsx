                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        value={passenger.documentType || "No Document"}
                        onChange={(e) =>
                          handleChange(index, "documentType", e.target.value)
                        }
                        className="w-full pl-10 pr-4 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary appearance-none bg-white"
                        required>
                        <option value="Regular Passport">
                          Regular Passport
                        </option>
                        <option value="Virgin Passport">Virgin Passport</option>
                  ...
                  <Input
                    ...
                    placeholder="Passport, NIN or Reference Number"
